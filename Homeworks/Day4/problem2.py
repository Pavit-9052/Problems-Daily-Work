...
while points_A < 5 or points_B < 5:
...
['*', '*', '*', '*', '*', '*']
['B', '*', '*', '*', 'B', '*']
Player A has rolled row=3 and col=3.
['*', '*', '*', 'A', '*', '*']
['A', '*', '*', '*', '*', '*']
['*', '*', 'A', 'A', 'B', '*']
['*', '*', '*', '*', '*', '*']
...
['*', '*', 'B', '*', '*', '*']
['B', '*', '*', '*', 'B', '*']
Player A has rolled row=6 and col=1.
['*', '*', '*', 'A', '*', '*']
['A', '*', '*', '*', '*', '*']
['*', '*', 'A', 'A', 'B', '*']
['*', '*', '*', '*', '*', '*']
...
['*', '*', 'B', '*', '*', '*']
['A', '*', 'A', 'A', 'B', '*']
Player B has rolled row=3 and col=2.
['*', '*', 'B', 'A', '*', '*']
['A', '*', '*', '*', '*', '*']
['*', 'B', 'A', 'A', 'A', '*']
['*', '*', 'B', '*', '*', '*']
...
['*', '*', 'B', '*', 'A', '*']
['A', '*', 'A', 'A', 'B', '*']
Player A has rolled row=4 and col=3.
['*', '*', 'B', 'A', 'B', '*']
['A', '*', '*', '*', '*', 'B']
['*', 'A', 'A', 'A', 'A', '*']
['*', '*', 'A', '*', '*', '*']
...
['*', '*', 'B', 'B', 'B', '*']
['A', '*', 'A', 'A', 'B', '*']
Player B has rolled row=2 and col=1.
['*', '*', 'B', 'A', 'B', '*']
['B', '*', '*', '*', '*', 'B']
['*', 'A', 'A', 'A', 'A', '*']
['*', '*', 'A', '*', '*', 'A']
...
['*', '*', 'B', 'B', 'B', 'A']
['A', 'A', 'B', 'A', 'B', 'B']
Player A has rolled row=1 and col=1.
['A', 'B', 'B', 'A', 'B', 'B']
['B', 'B', 'A', 'A', 'A', 'B']
['*', 'A', 'A', 'A', 'A', '*']
['B', 'A', 'A', '*', '*', 'A']
